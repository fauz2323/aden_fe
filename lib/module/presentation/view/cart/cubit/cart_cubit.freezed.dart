...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({UserCartEntities userCart, int total});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(this.userCart, this.total);

  @override
  final UserCartEntities userCart;
  @override
  final int total;

  @override
  String toString() {
    return 'CartState.loaded(userCart: $userCart, total: $total)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, userCart, total);
...
abstract class _Loaded implements CartState {
  const factory _Loaded(final UserCartEntities userCart, final int total) =
      _$LoadedImpl;

  UserCartEntities get userCart;
  int get total;
  @JsonKey(ignore: true)
  _$$LoadedImplCopyWith<_$LoadedImpl> get copyWith =>
      throw _privateConstructorUsedError;
...
class __$$UnauthorizedImplCopyWithImpl<$Res>
    extends _$CartStateCopyWithImpl<$Res, _$UnauthorizedImpl>
